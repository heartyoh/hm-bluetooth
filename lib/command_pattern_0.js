...
module.exports = {
  ADC: common.get(2, "PIO# Voltage", "PIO Voltage", /0.00/, "OK+ADC", [{
    name: "PIO#",
    desc: "map to PIO3~PIOB",
    pattern: /[3-B]/
  }]), // TODO result value prefix 형태가 특이함 OK+ADC#: 패턴임.
  ADDR: common.get(3, "MAC Address", "MAC Address", /[W]+12/, "OK+ADDR:"),
  ADVI: common.getset(3, "Advertising Interval", [
  ...
  ADTY: common.getset(4, "Advertising Type", [
